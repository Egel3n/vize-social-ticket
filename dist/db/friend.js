...
exports.getFriendshipID = exports.updateStatusFriendshipRequest = exports.getFriendshipRequests = exports.sendFriendRequest = void 0;
...
var getFriendshipID = function (friend1, friend2) { return __awaiter(void 0, void 0, void 0, function () {
    var friendship;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dbClient_1.default.friend.findFirst({
                    where: {
                        AND: [
                            {
                                OR: [
